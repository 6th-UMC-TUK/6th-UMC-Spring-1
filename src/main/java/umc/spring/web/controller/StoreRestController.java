...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.AddResultDTO> addStore(@RequestBody @Valid StoreRequestDTO.AddStoreDto request){
        Store store = storeCommandService.AddStoreByRegion(request);
    ...
    public ApiResponse<StoreResponseDTO.MissionPreViewListDTO> getMissionList(@StoreExists @PathVariable(name = "storeId") Long storeId, @RequestParam(name = "page") Integer page){
